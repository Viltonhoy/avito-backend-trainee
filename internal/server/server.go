...
func NewServer(logger *zap.Logger, storage *storage.Storage, afterShutdown func()) (*Server, error) {
	if logger == nil {
	...
	mux.HandleFunc("/create", h.CreateNewAd)
	mux.HandleFunc("/getad", h.GetAd)
	mux.HandleFunc("/readlist", h.GetAdList)
